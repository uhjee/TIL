...
Page2.getInitialProps = async ({
  ...
  const {
    sayHello
  } = await __webpack_require__.e(/* import() */ 559).then(__webpack_require__.bind(__webpack_require__, 559));
  console.log(sayHello()); // throw new Error('exception in getInitialProps');
...
function Page2({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
    children: [/*#__PURE__*/jsx_runtime_.jsx("p", {
      ...
      children: `10 + 20 = ${(0,util/* add */.I)(10, 20)}`
    })]
  });
}
